...
<head>
  ...
  <title>Data Analysis Pro | الشروط والأحكام</title>
        ...
        <article class="space-y-16 relative z-10">
          ...
          <section class="group">
            ...
            <div class="text-on-surface/80 leading-relaxed text-lg space-y-4">
              <p>أهلاً بك في منصة DATA ANALYSIS PRO. تسجيلك في الكورس (سواء النسخة الأساسية أو مع الإضافات المجانية)
                يعني موافقتك على هذه الشروط والأحكام.</p>
              <p>يرجى قراءة هذه البنود بعناية لضمان تجربة تعليمية سلسة ومثمرة خلال فترة الكورس (8 أسابيع).</p>
            </div>
          </section>
          ...
          <section class="group">
            <div class="flex items-center gap-4 mb-6">
              ...
              <h2 class="text-2xl font-extrabold text-primary tracking-wide">التسجيل وطرق الدفع</h2>
            </div>
            <div class="text-on-surface/80 leading-relaxed text-lg">
              <ul class="space-y-4 list-none">
                <li class="flex items-start gap-3">
                  ...
                  <span><strong>الرسوم:</strong> تكلفة الكورس المخفضة هي 4,500 جنيه مصري شاملة الضريبة والوصول مدى
                    الحياة للمحتوى المسجل.</span>
                </li>
                <li class="flex items-start gap-3">
                  <span class="mt-1.5 w-2 h-2 rounded-full bg-secondary flex-shrink-0"></span>
                  <span><strong>أمان الدفع:</strong> تتم كافة عمليات الدفع من خلال بوابات آمنة ومشفرة 100%.</span>
                </li>
                <li class="flex items-start gap-3">
                  <span class="mt-1.5 w-2 h-2 rounded-full bg-secondary flex-shrink-0"></span>
                  <span><strong>المقاعد محدودة:</strong> التسجيل متاح بناءً على الأسبقية. الخصم المتاح لفترة محدودة وقد
                    يتغير في أي وقت.</span>
                </li>
              </ul>
            </div>
          </section>
          ...
          <section class="group">
            <div class="flex items-center gap-4 mb-6">
              <span class="material-symbols-outlined text-primary text-3xl" data-icon="copyright">copyright</span>
              <h2 class="text-2xl font-extrabold text-primary tracking-wide">حقوق الملكية الفكرية</h2>
            </div>
            <div class="text-on-surface/80 leading-relaxed text-lg space-y-4">
              <p>جميع المواد التعليمية (الـ 16 محاضرة المباشرة، المشاريع العملية، ورشة التقارير، وملفات Eraa Data Camp)
                هي
                ملكية حصرية للمدرب محمد عبدالفتاح ومنصة Data Analysis Pro.</p>
              <div
                class="flex items-center gap-3 p-4 bg-error-container/10 rounded-lg text-error border border-error-container/20">
                <span class="material-symbols-outlined" data-icon="warning"
                  style="font-variation-settings: 'FILL' 1;">warning</span>
                <span class="font-bold">يمنع منعاً باتاً تسجيل أو تحميل أو مشاركة المحتوى التعليمي مع أي أطراف أخرى.
                  مشاركتك للمحتوى تعرضك للمساءلة القانونية وإلغاء حسابك فوراً دون استرداد الرسوم.</span>
              </div>
            </div>
          </section>
          <!-- Section 5: Student Commitment -->
          <section class="group">
            <div class="flex items-center gap-4 mb-6">
              <span class="material-symbols-outlined text-primary text-3xl" data-icon="school">school</span>
              <h2 class="text-2xl font-extrabold text-primary tracking-wide">التزام المتدرب</h2>
            </div>
            <p class="text-on-surface/80 leading-relaxed text-lg">لتحقيق أقصى استفادة (الوصول لمستوى الاحتراف وبناء
              بورتفوليو قوي)، يُتوقع من المتدرب حضور الجلستين الأسبوعيتين والمشاركة الفعالة في المشاريع والمهام
              المطلوبة.</p>
          </section>
          ...
          <section class="group">
            ...
            <div
              ...
              <div class="text-center md:text-right">
                <p class="text-lg mb-2">عندك أي سؤال بخصوص الشروط أو التسجيل؟</p>
                <p class="text-on-surface/60">تواصل معانا وفريقنا هيرد عليك فوراً لمساعدتك.</p>
              </div>
              <a class="bg-primary text-on-primary px-8 py-4 rounded-full font-black hover:scale-105 transition-transform duration-200"
                href="mailto:support@dataanalysispro.com">
                مراسلة الدعم الفني
              </a>
            </div>
          </section>
